...
const publicEventModel = {
    ...
    viewActivePublicEvents: (callback) => {
        const query = 'SELECT e.event_public_id, e.event_public_name, e.event_public_amount, e.event_public_description, e.event_public_date, e.event_public_time, e.event_public_image, e.event_syllabus, e.event_venue,e.event_public_duration,e.event_public_online,e.event_public_offline,e.event_public_recorded,a_added.admin_username as event_addedby, a_updated.admin_username as event_updatedby, e.event_added_date, e.event_updated_date, CASE WHEN e.delete_status = 0 THEN "active" ELSE "deleted" END AS delete_status, CASE WHEN e.cancel_status = 0 THEN "active" ELSE "cancelled" END AS cancel_status,CASE WHEN e.is_completed=0 THEN "not completed" ELSE "completed" END AS is_completed,e.certificate_generated FROM event_public e JOIN admin a_added ON e.event_addedby = a_added.admin_id JOIN admin a_updated ON e.event_updatedby = a_updated.admin_id where e.delete_status=0 and e.cancel_status=0 and e.is_completed=0 ORDER BY e.event_public_id';
        pool.query(query, callback);
    },
    viewDeletedPublicEvents: (callback) => {
        const query = 'SELECT e.event_public_id, e.event_public_name, e.event_public_amount, e.event_public_description, e.event_public_date, e.event_public_time, e.event_public_image, e.event_syllabus, e.event_venue,e.event_public_duration,e.event_public_online,e.event_public_offline,e.event_public_recorded,a_added.admin_username as event_addedby, a_updated.admin_username as event_updatedby, e.event_added_date, e.event_updated_date, CASE WHEN e.delete_status = 0 THEN "active" ELSE "deleted" END AS delete_status, CASE WHEN e.cancel_status = 0 THEN "active" ELSE "cancelled" END AS cancel_status,CASE WHEN e.is_completed=0 THEN "not completed" ELSE "completed" END AS is_completed,e.certificate_generated FROM event_public e JOIN admin a_added ON e.event_addedby = a_added.admin_id JOIN admin a_updated ON e.event_updatedby = a_updated.admin_id where e.delete_status=1 and e.cancel_status=1 ORDER BY e.event_public_id';
        pool.query(query, callback);
    },
    viewRegPublicEvents: (email, callback) => {
        const query = `SELECT u.user_id,e.event_public_id,e.event_public_name, e.event_public_description, e.event_public_date, e.event_public_time, e.event_public_image, e.event_syllabus, e.event_public_duration, e.event_public_online, e.event_public_offline, e.event_public_recorded,e.delete_status,e.cancel_status,e.is_completed,e.certificate_generated FROM event_public e JOIN payment_user p ON e.event_public_id = p.payment_event_id JOIN user u ON p.user_id = u.user_id WHERE u.user_email = ?`;
    ...
    viewCompletedEvents: (callback) => {
        const query = 'SELECT e.event_public_id, e.event_public_name, e.event_public_amount, e.event_public_description, e.event_public_date, e.event_public_time, e.event_public_image, e.event_syllabus, e.event_venue,e.event_public_duration,e.event_public_online,e.event_public_offline,e.event_public_recorded,a_added.admin_username as event_addedby, a_updated.admin_username as event_updatedby, e.event_added_date, e.event_updated_date, CASE WHEN e.delete_status = 0 THEN "active" ELSE "deleted" END AS delete_status, CASE WHEN e.cancel_status = 0 THEN "active" ELSE "cancelled" END AS cancel_status,CASE WHEN e.is_completed=0 THEN "not completed" ELSE "completed" END AS is_completed,e.certificate_generated FROM event_public e JOIN admin a_added ON e.event_addedby = a_added.admin_id JOIN admin a_updated ON e.event_updatedby = a_updated.admin_id where e.is_completed=1 ORDER BY e.event_public_id';
        pool.query(query, callback);
    },
    ...
    searchPublicEventsUser: (searchTerm, callback) => {
        const query = 'SELECT e.event_public_id, e.event_public_name, e.event_public_amount, e.event_public_description, e.event_public_date, e.event_public_time, e.event_public_image, e.event_syllabus, e.event_venue, e.event_public_duration,e.event_public_online,e.event_public_offline,e.event_public_recorded,a_added.admin_username as event_addedby, a_updated.admin_username as event_updatedby, e.event_added_date, e.event_updated_date, CASE WHEN e.delete_status = 0 THEN "active" ELSE "deleted" END AS delete_status, CASE WHEN e.cancel_status = 0 THEN "active" ELSE "cancelled" END AS cancel_status,CASE WHEN e.is_completed=0 THEN "not completed" ELSE "completed" END AS is_completed,e.certificate_generated FROM event_public e JOIN admin a_added ON e.event_addedby = a_added.admin_id JOIN admin a_updated ON e.event_updatedby = a_updated.admin_id where e.event_public_name LIKE ? AND delete_status=0 AND cancel_status=0 AND is_completed=0 ORDER BY e.event_public_name ASC';
        pool.query(query, [`%${searchTerm}%`], callback);
    }
