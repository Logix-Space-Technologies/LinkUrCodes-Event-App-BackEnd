...
const publicEventModel = {
    ...
    viewRegPublicEvents:(callback)=>{
        const query='SELECT e.event_public_name,e.event_public_description,e.event_public_date, e.event_public_time,e.event_public_image,e.event_syllabus,e.event_public_duration,e.event_public_online,e.event_public_offline,e.event_public_recorded FROM event_public e JOIN payment_user p ON e.event_public_id = p.payment_event_id WHERE user_id=?'
